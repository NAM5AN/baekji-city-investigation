...
const GROUPS = Object.freeze({
  core: [
    ...
    "stage8b-writer-census-guard-check.mjs",
    "world-persistence-writer-ingress-check.mjs",
    "world-persistence-runtime-check.mjs",
    "world-store-runtime-check.mjs",
    "security-rpc-catalog-contract-check.mjs",
    "legacy-player-world-rpc-permissions-check.mjs",
    "player-world-command-catalog-check.mjs",
    "player-world-command-engine-check.mjs",
    "player-world-derived-effects-check.mjs",
    "player-command-envelope-contract-check.mjs",
    "player-world-command-contract-check.mjs",
    "player-decline-command-contract-check.mjs",
    "player-cancel-command-contract-check.mjs",
    "player-invite-command-contract-check.mjs",
    "player-accept-command-contract-check.mjs",
    "player-rename-party-command-contract-check.mjs",
    "player-create-party-command-contract-check.mjs",
    "player-toggle-party-ready-command-contract-check.mjs",
    "player-lock-party-composition-command-contract-check.mjs",
    "data-check.mjs",
  ...
  player: [
    ...
    "player-world-party-reducer-check.mjs",
    "player-world-investigation-reducer-check.mjs",
    "player-world-inventory-reducer-check.mjs",
    "player-world-ai-reducer-check.mjs",
    "player-world-command-runtime-check.mjs",
    "player-world-projection-contract-check.mjs",
    "player-world-projection-runtime-check.mjs",
    ...
    "item-transfer-privacy-check.mjs",
    ...
    "tester-registry-guard-check.mjs",
  ...
  sync: [
    ...
    "player-session-boundary-runtime-check.mjs",
    "cloud-command-applied-refresh-check.mjs",
  ],
  admin: [
    "admin-dashboard-status-direct-render-runtime-check.mjs",
    "admin-observation-direct-members-runtime-check.mjs",
    "admin-feature-module-contract-check.mjs",
    "admin-zone-topology-runtime-check.mjs",
    ...
    "admin-communications-direct-sender-runtime-check.mjs",
  ...
  server: [
    "ai-server-check.mjs",
    "player-world-ai-command-api-check.mjs",

...
const box={window:{},globalThis:{},Date,JSON,Map,Set,Object,String,Number,Math,console};box.globalThis.window=box.window;vm.createContext(box);vm.runInContext(runtimeUtils,box);vm.runInContext(domainRules,box);vm.runInContext(source,box);

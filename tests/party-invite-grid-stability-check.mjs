...
assert.match(index, /app\.js\?v=0\.4\.9[^"']*party-invite-grid-stability=1[^"']*stage3a=1[^"']*stage3b=1[^"']*stage3c=1/, "app cache key must identify the first-paint invite grid and Stage 3-C caller-adoption implementation");

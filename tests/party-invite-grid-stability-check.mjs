...
assert.match(index, /app\.js\?v=0\.4\.8[^"']*party-invite-grid-stability=1[^"']*stage3a=1[^"']*stage3b=1/, "app cache key must identify the first-paint invite grid and Stage 3-B domain-rule implementation");

...
assert.match(index, /app\.js\?v=0\.4\.11[^"']*party-invite-grid-stability=1[^"']*stage3a=1[^"']*stage3b=1[^"']*stage3c=1[^"']*transfer-privacy=1[^"']*movement-departure-presence=1/, "app cache key must identify the current combined implementation");

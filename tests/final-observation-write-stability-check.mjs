...
// This is the exact former ping-pong: action-log-sync attempts a generic v2
// rewrite of a state whose canonical final v3 form is already stored. The lower
// canonicalizer must drop it before native storage/cloud sees any write.
...
// A real unrelated world change must still persist, while the finalized
// observation remains canonical.

...
assert.match(index, /investigation-feedback-ui\.css\?v=0\.3\.48/);
assert.match(index, /investigation-feedback-ui\.js\?v=0\.3\.48/);
assert.ok(index.indexOf("app.js?v=0.3.18") < index.indexOf("investigation-feedback-ui.js?v=0.3.48"));

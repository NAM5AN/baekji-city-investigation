...
assert.deepEqual({ ...api.classifySound('/"누구 있어?"라고 크게 외친다') }, { level: "LOUD", kind: "SHOUT", quote: "누구 있어?" });
...
const shout = makeState('/"누구 있어?"라고 크게 외친다');
...
console.log("PASS: 일반 말하기는 현장 한정 · 큰 소리는 동일 층/인접 장소 전파 · 대형 폭음과 모브 반응 확장점");
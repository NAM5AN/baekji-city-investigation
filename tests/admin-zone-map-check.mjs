...
console.log("PASS: admin zone tab reuses the investigation map topology with clickable nodes, occupancy highlighting, live route/detail scopes, and list fallback");

...
assert.ok(app.includes('MAP: "MAP"'));
assert.ok(app.includes('if (kind === "MAP") showMapModal(sessionId)'));
assert.ok(app.includes('PLAYER_WORLD_COMMANDS__.dispatch("INVESTIGATION_ACTION_V1"'), "a chat map request is recorded by the command boundary before its UI modal opens");

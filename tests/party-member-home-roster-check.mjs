...
assert.match(index, /party-member-home-roster\.js\?v=0\.3\.92/);
console.log("PASS: member home shows inline roster and newly created leader party starts at the top");

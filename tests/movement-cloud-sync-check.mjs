...
assert.match(index, /app\.js\?v=0\.4\.8&fix=0b1[^"']*movement-terminal=1[^"']*stage3a=1[^"']*stage3b=1/, "movement terminal markers must ship behind a fresh browser cache key");

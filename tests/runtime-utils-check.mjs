...
for (const consumer of [
  ...
  "action-log-sync.js?v=0.4.1&stage3a=1",
  "runtime-baseline-stability.js?v=0.4.4&stage3a=1",
  "app.js?v=0.4.7&fix=0b1&local-chat=1&movement-terminal=1&flex-hazard-terminal=1&topbar=1&stage2-foundation-ui=1&stage2-briefing-ui=1&stage2-party-ui=1&stage2-home-briefing-party-ui=1&pending-party-invites=1&party-member-readiness-ux=1&party-invite-grid-stability=1&party-confirmed-ready-collapse=1&pending-departure-set-guard=1&result-party-disband=1&departure-guards=1&stage3a=1",
  "party-flow-ux-fix.js?v=0.3.87&departure-capture-guard=1&stage3a=1",
  "party-leadership-flow.js?v=0.3.68&stage3a=1",
  "party-roster-modal.js?v=0.3.72&stage3a=1",
  "party-flow-sync.js?v=0.3.67&stage3a=1",
  "party-reinvite-runtime-fix.js?v=0.3.89&stage3a=1",
  "party-membership-ux-fix.js?v=0.3.87&stage3a=1",
  "party-preflight-flow-fix.js?v=0.3.96&stage3a=1",
  "party-ui-stability.js?v=0.3.93&stage3a=1",
  "party-member-home-roster.js?v=0.3.98&stage3a=1",
  "character-interaction-ai.js?v=0.4.2&stage3a=1",
  "cross-party-hazard-interaction.js?v=0.3.77&stage3a=1",
  "party-transfer-flow.js?v=0.3.78&stage3a=1",
